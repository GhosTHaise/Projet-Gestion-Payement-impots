...
const Down = ({registeredRoutes,actualLink,setactualLink,registerButton}) => {
    const nextButton = () => {
  ...
  return (
    ...
    <div className={`${styles.flexCenter} w-full relative h-[60px]`}>
            ...
            <button onClick={actualLink != 2 ? nextButton : registerButton} className={`${styles.flexCenter} w-[125px] py-4 px-8 glass-effect rounded-full outline-none absolute right-0 border-solid border-[#7a7a7a] border-[1px] `}buttontype="button">
                        {actualLink != 2 ? (
